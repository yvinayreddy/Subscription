...
function LoginPage() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Welcome back!");
            router.push("/");
        } catch (err) {
            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(err instanceof Error ? err.message : "Login failed");
        } finally{
            setLoading(false);
        }
    }
...
_s(LoginPage, "KiN189CSyqjTihfqfptMCovbQwg=", false, function() {
    return [
...
//# sourceMappingURL=frontend_90433e04._.js.map